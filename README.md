...
Download CARLA 0.9.9 from [here](https://github.com/carla-simulator/carla/releases/tag/0.9.9). (Our setup works with CARLA 0.9.9 version. Using another version of the simulator will result in a version and API mismatch error.)
